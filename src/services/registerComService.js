...
export const registerCompetition = async (data) => {
  ...
  //   if (calculateDistanceFromDate(new Date(), competition.timeStart) <= 2) {
  //     throw new HttpException(
  //       400,
  //       ErrorMessage.CUSTOM("competition expired registration")
  //     );
  //   }
...
export const unRegisterCompetition = async (data) => {
  ...
  //     throw new HttpException(
  //       400,
  //       ErrorMessage.CUSTOM("competition expired unregistration")
  //     );
  //   }
